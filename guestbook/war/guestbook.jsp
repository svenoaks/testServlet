...
<body>
	...
	<form action="/images.jsp" method="get">
		<div>
			<input type="submit" value="View your private images" />
		</div>
	...
	<%
		...
		List<Entity> greetings = datastore.prepare(query).asList(
				FetchOptions.Builder.withLimit(7));
	...
	<%
		for (Entity greeting : greetings) {
				...
				pageContext.setAttribute("sessionId_content",
						greeting.getProperty("sessionId"));
	...
	%>
	<blockquote>
		${fn:escapeXml(greeting_content)} <br> <span style="color: red">${fn:escapeXml(sessionId_content)}</span>
	</blockquote>
	<%
		}
		}
